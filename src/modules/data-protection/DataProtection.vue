<template>
    <div v-if="$i18n.locale === locales.DE" class="data-protection">
        <h4>Datenschutzerklärung</h4>

        <p>
            Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders hohen
            Stellenwert für die Geschäftsleitung der Weichwarenprojekt GbR. Eine Nutzung der Internetseiten der
            Weichwarenprojekt GbR ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine
        ...
        <p>
            ...
            Übereinstimmung mit den für die Weichwarenprojekt GbR geltenden landesspezifischen Datenschutzbestimmungen.
        ...
        <p>
            Die Weichwarenprojekt GbR hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
        ...
        <p>
            Die Datenschutzerklärung der Weichwarenprojekt GbR beruht auf den Begrifflichkeiten, die durch den
        ...
        <p>Weichwarenprojekt GbR</p>
        <p>Hauptstraße 48</p>
        <p>89614 Öpfingen</p>
        <p>Deutschland</p>
        <p>Tel.: -</p>
        <p>E-Mail: info@weichwarenprojekt.de</p>
        <p>Website: www.weichwarenprojekt.de</p>

        <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
        <p>
            Die Internetseite der Weichwarenprojekt GbR erfasst mit jedem Aufruf der Internetseite durch eine betroffene
        ...
        <p>
            Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Weichwarenprojekt GbR keine
            ...
            Daten und Informationen werden durch die Weichwarenprojekt GbR daher einerseits statistisch und ferner mit
        ...
        <p>
            Die Internetseite der Weichwarenprojekt GbR enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine
        ...
        <ul style="list-style: none">
            ...
            <li>
                ...
                <p>
                    ...
                    personenbezogenen Daten, die bei der Weichwarenprojekt GbR gespeichert sind, veranlassen möchte,
                    kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
                    wenden. Der Mitarbeiter der Weichwarenprojekt GbR wird veranlassen, dass dem Löschverlangen
                    unverzüglich nachgekommen wird.
                </p>

                <p>
                    Wurden die personenbezogenen Daten von der Weichwarenprojekt GbR öffentlich gemacht und ist unser
                    Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
                    Daten verpflichtet, so trifft die Weichwarenprojekt GbR unter Berücksichtigung der verfügbaren
                    ...
                    Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Weichwarenprojekt GbR wird im Einzelfall
            ...
            <li>
                ...
                <p>
                    ...
                    Einschränkung von personenbezogenen Daten, die bei der Weichwarenprojekt GbR gespeichert sind,
                    verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
                    Verantwortlichen wenden. Der Mitarbeiter der Weichwarenprojekt GbR wird die Einschränkung der
            ...
            <li>
                ...
                <p>
                    ...
                    einen Mitarbeiter der Weichwarenprojekt GbR wenden.
                </p>
            </li>
            <li>
                ...
                <p>
                    Die Weichwarenprojekt GbR verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht
                ...
                <p>
                    Verarbeitet die Weichwarenprojekt GbR personenbezogene Daten, um Direktwerbung zu betreiben, so hat
                    ...
                    Weichwarenprojekt GbR der Verarbeitung für Zwecke der Direktwerbung, so wird die Weichwarenprojekt
                ...
                <p>
                    ...
                    Weichwarenprojekt GbR zu wissenschaftlichen oder historischen Forschungszwecken oder zu
                ...
                <p>
                    Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden Mitarbeiter
                    der Weichwarenprojekt GbR oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es
            ...
            <li>
                ...
                <p>
                    ...
                    Einwilligung der betroffenen Person, trifft die Weichwarenprojekt GbR angemessene Maßnahmen, um die
                ...
                <p>
                    Möchte die betroffene Person Rechte mit Bezug auf automatisierte Entscheidungen geltend machen, kann
        ...
        <p>
            ...
            <a href="https://dg-datenschutz.de/datenschutzerklaerung/" rel="nofollow"
                >Datenschutzerklärungs-Generator</a
            >
            der Deutschen Gesellschaft für Datenschutz, in Kooperation mit den
            <a href="https://www.wbs-law.de/taetigkeitsgebiete/medienrecht/">Medienrecht</a> Anwälten WILDE BEUGER
            SOLMECKE | Rechtsanwälte erstellt.
        </p>
    </div>
    <div v-else class="data-protection">
        <h4>Privacy Policy</h4>

        <p>
            We are very delighted that you have shown interest in our enterprise. Data protection is of a particularly
            high priority for the management of the Weichwarenprojekt GbR. The use of the Internet pages of the
            Weichwarenprojekt GbR is possible without any indication of personal data; however, if a data subject wants
        ...
        <p>
            ...
            the country-specific data protection regulations applicable to the Weichwarenprojekt GbR. By means of this
        ...
        <p>
            As the controller, the Weichwarenprojekt GbR has implemented numerous technical and organizational measures
        ...
        <h4>1. Definitions</h4>
        <p>
            The data protection declaration of the Weichwarenprojekt GbR is based on the terms used by the European
        ...
        <p>Deutschland</p>
        <p>Phone: -</p>
        <p>Email: info@weichwarenprojekt.de</p>
        <p>Website: www.weichwarenprojekt.de</p>

        <h4>3. Collection of general data and information</h4>
        <p>
            The website of the Weichwarenprojekt GbR collects a series of general data and information when a data
            subject or automated system calls up the website. This general data and information are stored in the server
            log files. Collected may be (1) the browser types and versions used, (2) the operating system used by the
        ...
        <p>
            When using these general data and information, the Weichwarenprojekt GbR does not draw any conclusions about
            the data subject. Rather, this information is needed to (1) deliver the content of our website correctly,
            (2) optimize the content of our website as well as its advertisement, (3) ensure the long-term viability of
            our information technology systems and website technology, and (4) provide law enforcement authorities with
            the information necessary for criminal prosecution in case of a cyber-attack. Therefore, the
            Weichwarenprojekt GbR analyzes anonymously collected data and information statistically, with the aim of
        ...
        <p>
            The website of the Weichwarenprojekt GbR contains information that enables a quick electronic contact to our
        ...
        <ul style="list-style: none">
            ...
            <li>
                ...
                <p>
                    ...
                    personal data stored by the Weichwarenprojekt GbR, he or she may, at any time, contact any employee
                    of the controller. An employee of Weichwarenprojekt GbR shall promptly ensure that the erasure
                ...
                <p>
                    ...
                    not required. An employees of the Weichwarenprojekt GbR will arrange the necessary measures in
                    individual cases.
                </p>
            </li>
            <li>
                ...
                <p>
                    ...
                    of the processing of personal data stored by the Weichwarenprojekt GbR, he or she may at any time
                    contact any employee of the controller. The employee of the Weichwarenprojekt GbR will arrange the
            ...
            <li>
                ...
                <p>
                    ...
                    employee of the Weichwarenprojekt GbR.
                </p>
            </li>
            <li>
                ...
                <p>
                    The Weichwarenprojekt GbR shall no longer process the personal data in the event of the objection,
                ...
                <p>
                    If the Weichwarenprojekt GbR processes personal data for direct marketing purposes, the data subject
                    ...
                    If the data subject objects to the Weichwarenprojekt GbR to the processing for direct marketing
                    purposes, the Weichwarenprojekt GbR will no longer process the personal data for these purposes.
                </p>

                <p>
                    In addition, the data subject has the right, on grounds relating to his or her particular situation,
                    to object to processing of personal data concerning him or her by the Weichwarenprojekt GbR for
                ...
                <p>
                    ...
                    Weichwarenprojekt GbR. In addition, the data subject is free in the context of the use of
                    information society services, and notwithstanding Directive 2002/58/EC, to use his or her right to
            ...
            <li>
                ...
                <p>
                    ...
                    Weichwarenprojekt GbR shall implement suitable measures to safeguard the data subject's rights and
                ...
                <p>
                    ...
                    he or she may, at any time, contact any employee of the Weichwarenprojekt GbR.
                </p>
            </li>
            <li>
                ...
                <p>
                    ...
                    time, contact any employee of the Weichwarenprojekt GbR.
                </p>
            </li>
        </ul>
        ...
        <h4>
            10. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into
        ...
        <p>
            Developed by the specialists for <a href="https://willing-able.com/">LegalTech</a> at Willing & Able that
            also developed the system for <a href="https://abletotrack.com/">day tracker</a>. The legal texts contained
            in our privacy policy generator have been provided and published by
            <a href="https://dg-datenschutz.de/">Prof. Dr. h.c. Heiko Jonny Maniero</a> from the German Association for
            Data Protection and <a href="https://www.wbs-law.de/" rel="nofollow">Christian Solmecke</a> from WBS law.
        </p>
    </div>
</template>
